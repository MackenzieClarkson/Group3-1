        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            ...
            <div class="item">
              ...
              <div class="container">
                <div class="carousel-caption">
                  ...
                  <p><a class="btn btn-lg btn-primary" href="#" role="button">Click Here for Latest Stats</a></p>
                </div>
              </div>
            ...
            <div class="item">
              ...
              <div class="container">
                <div class="carousel-caption">
                  <h1>Pictures and Vidoes of the Action</h1>
...
<div class="jumbotron">
    ...
    <!--  <div class="jumbotron">-->
      ...
      <div class="col-md-6">
        <ol class="lead pad-top">
          <li> we kee track of whats going on in social media</li>
  ...
  <div class="col-md-6">
      ...
      <div class="row featurette">
          ...
          <p class="lead pad-below">A stats table that allows you to look up stats for your favorite teams.  Anything to linups on gameday, to recorded stats of individual players</p>
      </div>
      <div class="row featurette">
    ...
    <script src="D:/Users/Macdaddy/Desktop/Web Programming Lab1/bootstrap-3.3.7-dist/js/bootstrap.min.js"></script>
...
>>>>>>> refs/remotes/origin/master:bootstrap-3.3.7-dist/index.html
